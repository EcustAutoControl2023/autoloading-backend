Feature: connect接口测试
  Scenario Outline: 5.1.1 0、推送任务信息，返回引导策略
    ...
    Examples: 5种装车过程（最后一种为错误情况）
      ...
      | ./test/json/postdata-2.json | [1.1, 1.1, 1.1] | [[1.1], []]                              |
      | ./test/json/postdata-2.json | [1.2, 1.2, 1.1] | [[1.2, 1.1], [1.1], []]                  |
      | ./test/json/postdata-2.json | [1.1, 1.2, 1.2] | [[1.1, 1.2], [1.2], []]                  |
      | ./test/json/postdata-2.json | [1.1, 1.2, 1.3] | [[1.1, 1.2, 1.3], [1.2, 1.3], [1.3], []] |
