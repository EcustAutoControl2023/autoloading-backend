...
def connect():
    ...
    # 新增
    guide_position = operating_stations.get("guide_position", None)
    ...
    truck_weight_out = (
        0
        if (truck_weight_out is None)
        or (isinstance(truck_weight_out, dict) or (isinstance(truck_weight_out, list)))
        else truck_weight_out
    )
    ...
    picture_url_plate = operating_stations.get(
        "picture_url_plate",
        "https://www.baidu.com/img/PCtm_d9c8750bed0b3c7d089fa7d55720d6cf.png",
    )
    picture_url_request = operating_stations.get(
        "picture_url_request",
        "https://www.baidu.com/img/PCtm_d9c8750bed0b3c7d089fa7d55720d6cf.png",
    )
    ...
    type_of_opening = (
        type_of_opening.replace("\n", "") if type_of_opening is not None else None
    )
    ...
    if data_type == 2:
        ...
        logging.debug(f"{truck_id}请求data_type:3")
        ...
        return_data = load_point_dict[loader_id].load_control(
            ...
            temp_manual_stop=temp_manual_stop,
            ...
            distance0=distance_0,
            distance1=distance_1,
            distance2=distance_2,
            icps_differ_current=icps_differ_current,
            picture_url_plate=picture_url_plate,
            picture_url_request=picture_url_request,
            jobid=job_id,
