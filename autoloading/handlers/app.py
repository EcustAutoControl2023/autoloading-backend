...
def connect():
    ...
    truck_id = operating_stations.get('truck_id') # {'truck_id':'闽D123456'}
    box_length = operating_stations.get('box_length') # {'box_length':1}
    box_width = operating_stations.get('box_width') # {'box_width':1}
    box_height = operating_stations.get('box_height') # {'box_height':1}
    distance_0 = operating_stations.get('distance_0') # {'distance_0':1}
    distance_1 = operating_stations.get('distance_1') # {'distance_1':1}
    distance_2 = operating_stations.get('distance_2') # {'distance_2':1}
    truck_load = operating_stations.get('truck_load') # {'truck_load':1}
    load_current = operating_stations.get('load_current') # {'load_current':1}
    truck_weight_in = operating_stations.get('truck_weight_in') # {'truck_weight_in':1}
    truck_weight_out = operating_stations.get('truck_weight_out') # {'truck_weight_out':1}
    goads_type = operating_stations.get('goads_type') # {'goads_type':1}
    store_id = operating_stations.get('store_id') # {'store_id':1}
    loader_id = operating_stations.get('loader_id') # {'loader_id':20}
    flag_operate = operating_stations.get('flag_operate') # {'flag_operate':1}
    allow_work_flag = operating_stations.get('allow_work_flag') # {'allow_work_flag':1}
    allow_plc_work = operating_stations.get('allow_plc_work') # {'allow_plc_work':1}
