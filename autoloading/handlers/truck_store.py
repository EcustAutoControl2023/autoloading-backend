...
def update_truck_content(truckid: str, loaderid, update_data):
    traffic = (
        Traffic.query.filter_by(truckid=truckid, loaderid=loaderid)
    ...
    for key, value in update_data.items():
        ...
        elif "loadlevelheightlist" == key:
            traffic.loadlevelheightlist = value
        elif "loadpointlist" == key:
            traffic.loadpointlist = value
        elif "loadheightbeginlist" == key:
            traffic.loadheightbeginlist = value
        elif "loadtimelist" == key:
            traffic.loadtimelist = value
        elif "loadweightendlist" == key:
            traffic.loadweightendlist = value
